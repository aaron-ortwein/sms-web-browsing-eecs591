...
def key_exchange():
    ...
    os.system(f'adb shell service call isms 5 i32 1 s16 "com.android.mms.service" s16 "null" s16 "{client_number}" s16 "null" s16 "\'{challenge}\'" s16 "null" s16 "null" i32 1 i64 0')
    ...
    while True:
        ...
        response = subprocess.run(
                ["adb", "shell", "content", "query", "--uri", "content://sms", "--projection", "body", "--where", f"\"address=\'{client_number}\' and date >= {challenge_start}\"", "|", 
